...
for first_num_first_dig in range(first_num_first_digit_start, 9):
    for first_num_second_dig in range(9, first_num_second_digit_start, -1):
        for second_num_first_dig in range(second_num_first_digit_start, 9):
            for second_num_second_dig in range(9, second_num_second_digit_start, -1):
                ...
                if is_valid and first_num == second_num:
                    ...
                    print(f"{first_num_first_dig}{first_num_second_dig} - {second_num_first_dig}{second_num_second_dig}")
                    counter += 1
                if counter >= 6:
                    has_ended = True
                if has_ended:
